title=Extexp User Documentation - An Extexp Project
date=2022-05-21
type=document
status=published
nextpage=commands
previouspage=installing
...
More details and examples the build file content can be found [here](commands.html).
...
![project level commands](resources/project-level-commands.png)&nbsp;&nbsp;![build file level commands](resources/buildfile-level-commands.png)
