title= NBPCG User Guide - Developer Notes
date=2022-05-21
type=document
status=published
nextpage=release
previouspage=install
...
Sources for this release can be found [here](https://github.com/The-Retired-Programmer/nbpcg/releases/tag/v5.0.1).
